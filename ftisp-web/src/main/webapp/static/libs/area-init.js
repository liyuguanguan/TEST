define('static/libs/area-init', ['require', 'exports', 'module'], function(require, exports, module) {

  // 纯JS省市区三级联动
  // 2011-11-30 by http://www.cnblogs.com/zjfree
  module.exports = function(_cmbProvince, _cmbCity, _cmbArea, defaultProvince, defaultCity, defaultArea)
  {
  ...
  var provinceList = [
      ...
      {name:'香港', cityList:[
          {name:'新界',areaList:['北区','大埔','葵青','离岛','荃湾','沙田','屯门','西贡','元朗']},
          {name:'九龙',areaList:['观塘','黄大仙','九龙城','深水埗','油尖旺']},
          {name:'香港岛',areaList:['东区','南区','湾仔','中西']},
      ]},
      {name:'澳门', cityList:[
      ]}
  ];
