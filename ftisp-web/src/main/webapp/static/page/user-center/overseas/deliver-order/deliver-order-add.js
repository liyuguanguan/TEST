define('page/user-center/overseas/deliver-order/deliver-order-add', ['require', 'exports', 'module', 'components/jquery/jquery', 'static/libs/validator', 'static/libs/alert', 'static/libs/bootstrap-typeahead'], function(require, exports, module) {
  ...
  function  formValidationinit() {
      $validator({form:'#outstore_form',button:'submit_form'},{
          warehouseId:{required:true},platType:{required:true},nameFirst:{required:true},
          nameSecond:{required:true},recipientCountryId:{required:true},recipientRegionName:{required:true},
          recipientCityName:{required:true},recipientZipcode:{required:true},recipientAddress1:{required:true},
          ...
          recipientCountryId:{required:'国家不能为空'},recipientRegionName:{required:'州不能为空'},
          recipientCityName:{required:'城市不能为空'},recipientZipcode:{required:'邮编不能为空'},
  ...
  function goodsValid() {
      ...
      var numsFlag =true;
      if($this1.val()*1<=0){
          $this1.parents('.form-group').addClass("has-error")
          ...
          if($this1.val()*1>$('#goods_add_table input:eq(1)').val()*1) {
              ...
              $this1.parents('.form-group').removeClass("has-error")
              $ndiv1.empty();
          }
      }
