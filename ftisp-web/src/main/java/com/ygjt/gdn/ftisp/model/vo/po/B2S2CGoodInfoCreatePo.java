 ...
 */
public class B2S2CGoodInfoCreatePo implements Serializable{
    ...
    private List<String> base64Pics;//商品图片ID
...
//    @Pattern(regexp = "^(([0-9]|([1-9][0-9]+))(\\.[0-9]{1,3}))|([0-9])|([1-9][0-9]+)$",message = "产品包装高格式不正确")
    ...
    public List<String> getBase64Pics() {
        return base64Pics;
    }

    public void setBase64Pics(List<String> base64Pics) {
        this.base64Pics = base64Pics;
    }
